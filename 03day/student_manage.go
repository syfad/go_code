...
//}
//
//func newstudent(name string, age int, score map[string]int) (*Student) {
//	return &Student{
//		Name: name,
//		Age: age,
//		Score: score,
...
//	var age,chinese,math,english int
//	var name string
...
//func add_stu() {
//	var stu_manage = &Student{}
//	fmt.Printf("请输入学生姓名：\n")
//	fmt.Scanf("%v", &stu_manage.name)
//	//fmt.Printf("请输入语文成绩：")
//	//fmt.Scanf("%v", &stu_manage.score)
//	//fmt.Printf("请输入数学成绩：")
//	//fmt.Scanf("%v", &stu_manage.score)
//	//fmt.Printf("请输入英语成绩：")
//	//fmt.Scanf("%v", &stu_manage.score)
